                    ...
                    switch (recievedUnit.messageCode)
                    {
                        ...
                        case ProtocolData.MessageCode.TURN:
                            // slučaj početka igre
                            {
                                ...
                                int randomPositiveNumber = random.Next(1, int.MaxValue);
                                int result = randomPositiveNumber % 2;
                                ...
                                networkStream.Write(responseBuff);
    ...
    void ListenForBroadcast()
    {
        ...
        while(true)
        {
            ...
            if (Encoding.ASCII.GetString(requestData) == "TACTOE")
            {
                ...
                udpClient.Send(responseBytes, responseBytes.Length, clientEP);
